...
public class Turtle implements Feature {
    ...
    private double[] myCoordinates={DEFAULT_CENTRE_COORDINATE,DEFAULT_CENTRE_COORDINATE};
    private double myAngle=DEFAULT_TURTLE_ANGLE;
    private Pen myPen;
    private Group myDrawing;
    private Group myLines;
    private Image myDefault = new Image(getClass().getResourceAsStream(DEFAULT_TURTLE_IMAGE
                                                                       ));
    ...
    public double[] getCoordinates () {
    	for (int i=0;i<2;i++){
    		myRelativeCoordinates[i]=myCoordinates[i]-DEFAULT_CENTRE_COORDINATE;
    	}
