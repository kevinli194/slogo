...
public class Turtle extends TurtleAbstract implements Feature {
    ...
    public void setCoordinates (double x, double y) {
        if (myState) {
            ...
            myImage.setTranslateX(myCoordinates[0] - DEFAULT_TURTLE_SIZE / 2);
            myImage.setTranslateY(myCoordinates[1] - DEFAULT_TURTLE_SIZE / 2);
            setTurtleInfo();
        }
    ...
    public double setHome () {
        List<double[]> coords = getCoordList(0, 0);

        return calculateDistance(coords.get(0), coords.get(1));
    }
