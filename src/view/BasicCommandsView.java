 ...
 */
public class BasicCommandsView extends DataComponents {
	 ...
	 * 
	 * @param commandsList
	 *            Data from the model that stores the commands
	 */
	 ...
	 * For JUnit testing
	 * 
	 * @return the number of elements that is in the view.
	 */
	public int countElements() {
		return myView.getChildren().size();
