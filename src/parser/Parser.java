...
public class Parser {
	...
	/**
	 * Iterates through string tokens in reverse order to create Instruction
	 * classes with the InstructionFactory
	 * 
	 * @param input
	 *            string input to be parsed
	 * @return a stack of instructions to be executed in the Model class
	 * @throws InvalidArgumentsException
	 *             throws when there is invalid parameter
	 */
	 ...
	 * 
	 * @param tokens
	 *            to be parsed and created into instructions
	 * @return stack of instructions
	 * @throws InvalidArgumentsException
	 *             throws when invalid parameters
	 */
	...
	/**
	 * For each instruction, checks to see how many inputs are needed for the
	 * instruction - Pops from double value stack if inputs are needed -
	 * 
	 * @param instr
	 *            instruction to add parameters to
	 * @param iStack
	 *            of parameters
	 * @throws InvalidArgumentsException
	 *             throws when there is not enough parameters
	 */
	private void addParams(Instruction instr, Stack<Instruction> iStack)
		...
		if (instr.getNumParams() > iStack.size()) {
			...
			throw new InvalidArgumentsException(PARAMETER_ERROR, this
